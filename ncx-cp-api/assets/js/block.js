/**
 * Gutenberg editor block for embedding a COPYandPAY widget by checkout ID.
 */
(function (blocks, i18n, element, components) {
    ...
    // Registers the NCX CopyAndPay widget block and its editor controls.
    blocks.registerBlockType('ncx/copyandpay-widget', {
        ...
        // Renders checkout ID and brand fields in the block editor sidebar.
        edit: function (props) {
        ...
        // Dynamic block – front-end output is rendered server-side in PHP.
        save: function () {
            return null;
        }
    });
