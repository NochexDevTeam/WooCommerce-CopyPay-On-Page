...
final class NCX_CP_API_Saved_Cards_Admin {
    ...
    public const MENU_SLUG    = 'ncx-cp-saved-cards';
    private const GATEWAY_ID  = 'ncx_cp_api';
    private const DELETE_ACTION = 'ncx_cp_delete_token';

    // Admin URL of this page, for links from elsewhere in the plugin.
    public static function page_url(): string {
        return admin_url('admin.php?page=' . self::MENU_SLUG);
    }

    // Wires the admin menu entry and token-delete handler.
    public function __construct() {
        add_action('admin_menu', [$this, 'register_menu'], 90);
        add_action('admin_init', [$this, 'handle_delete']);
    }

    // Adds the Saved Cards submenu under WooCommerce in wp-admin.
    ...
    // Processes secure admin requests to delete a saved card token.
    ...
    // Renders the Saved Cards admin table listing all gateway tokens.
